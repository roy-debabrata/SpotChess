...
public class MoveUtilTest {
    ...
    class CastlingTest {
        ...
        public void testKnightsPreventingCastling() {
            ...
            position = position(white(k(e1), r(a1, h1)), black(k(e8), n(a2, b2, b3, c3, f2)), Colour.WHITE);
            assertHasMoves(position, "O-O");
            assertDoesNotHaveMoves(position, "O-O-O");
            ...
            position = position(white(k(e1), r(a1, h1)), black(k(e8), n(d2, g3, h3, h2)), Colour.WHITE);
            assertHasMoves(position, "O-O-O");
            assertDoesNotHaveMoves(position, "O-O");
            ...
            position = position(white(k(e1), n(a7, b7, b6, c6, f7)), black(k(e8), r(a8, h8)), Colour.BLACK);
            assertHasMoves(position, "O-O");
            assertDoesNotHaveMoves(position, "O-O-O");
            ...
            position = position(white(k(e1), n(d7, g6, h6, h7)), black(k(e8), r(a8, h8)), Colour.BLACK);
            assertHasMoves(position, "O-O-O");
            assertDoesNotHaveMoves(position, "O-O");

            /* Negative checks knight not-preventing castling. */
            position = position(white(k(e1), r(a1)),
                    black(k(e8), n(except(a1, b1, c1, d1, e1, c2, e8, a2, b2, b3, c3, d3, e2, e3, f2, f3, g2))
                    ), Colour.WHITE);
            assertHasMoves(position, "O-O-O");

            position = position(white(k(e1), r(h1)),
                    black(k(e8), n(except(e1, f1, g1, h1, e8, c2, d2, e2, g2, d3, e3, f3, g3, h3, h2))
                    ), Colour.WHITE);
            assertHasMoves(position, "O-O");

            position = position(white(k(e1), n(except(a8, b8, c8, d8, e8, e1, a7, b7, c7, b6, c6, d6, e6, f6, e7, f7, g7))), black(k(e8), r(a8)), Colour.BLACK);
            assertHasMoves(position, "O-O-O");

            position = position(white(k(e1), n(except(e8, f8, g8, h8, e1, c7, d7, e7, d6, e6, f6, g6, h6, g7, h7))), black(k(e8), r(h8)), Colour.BLACK);
            assertHasMoves(position, "O-O");
        }
        ...
        public void testPawnsPreventingCastling() {
            ...
            position = position(white(k(e1), r(a1)),
                    black(k(e8), p(except(a1, b1, c1, d1, e1, f1, g1, h1, b2, c2, d2, e2, f2, a8, b8, c8, d8, e8, f8, g8, h8))),
                    Colour.WHITE);
            assertHasMoves(position, "O-O-O");

            position = position(white(k(e1), r(h1)),
                    black(k(e8), p(except(a1, b1, c1, d1, e1, f1, g1, h1, d2, e2, f2, g2, h2, a8, b8, c8, d8, e8, f8, g8, h8))),
                    Colour.WHITE);
            assertHasMoves(position, "O-O");

            position = position(white(k(e1), p(except(a1, b1, c1, d1, e1, f1, g1, h1, b7, c7, d7, e7, f7, a8, b8, c8, d8, e8, f8, g8, h8))),
                    black(k(e8), r(a8)),
                    Colour.BLACK);
            assertHasMoves(position, "O-O-O");

            position = position(white(k(e1), p(except(a1, b1, c1, d1, e1, f1, g1, h1, d7, e7, f7, g7, h7, a8, b8, c8, d8, e8, f8, g8, h8))),
                    black(k(e8), r(h8)),
                    Colour.BLACK);
            assertHasMoves(position, "O-O");
        }
    ...
    class PinsTest {
        ...
        public void testPinnedPawns() {
            ...
            position = position(position, withoutPieceAt(c6));
            ...
            position = position(position, withoutPieceAt(f2));
            ...
            position = position(position, withoutPieceAt(h8));
            ...
            position = position(position, withoutPieceAt(g7));
            ...
            position = position(position, withoutPieceAt(a1));
            ...
            position = position(position, withoutPieceAt(a8));
            ...
            position = position(position, withoutPieceAt(h2));
            ...
            position = position(position, withoutPieceAt(a3));
            ...
            position = position(position, withoutPieceAt(d1));
            ...
            position = position(position, withoutPieceAt(h1));
            ...
            position = position(position, withoutPieceAt(g2));
            ...
            position = position(position, withoutPieceAt(h7));
            ...
            position = position(position, withoutPieceAt(a6));
            ...
            position = position(position, withoutPieceAt(d8));
        ...
        public void testPinnedKnights() {
            ...
            position = position(position, withoutPieceAt(e5));
            assertHasMoves(position,"Nc2 Nb3 Nb5 Nc6 Ne6 Nf5 Nf3 Ne2");

            position = position(white(k(c5),n(d4)),black(k(a1),b(e3)),Colour.WHITE);
            assertDoesNotHaveMoves(position,"Nc2 Nb3 Nb5 Nc6 Ne6 Nf5 Nf3 Ne2");

            position = position(position, withoutPieceAt(e3));
            assertHasMoves(position,"Nc2 Nb3 Nb5 Nc6 Ne6 Nf5 Nf3 Ne2");
        ...
        public void testPinnedRooks() {
            ...
            position = position(position, withoutPieceAt(a7));
            ...
            position = position(position, withoutPieceAt(g1));
        ...
        public void testPinnedBishops() {
            ...
            position = position(position, withoutPieceAt(b7));
